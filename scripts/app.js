(function () {
    ...
    (undefined && undefined.__assign) || Object.assign || function(t) {
        ...
        Bezier: function (v, k, value) {
            ...
            for (var i = 0; i <= n; i++) {
                if (typeof b === 'number') {
                    ...
                    var STRING_BUFFER = '', idx = Math.round(n * k), pidx = idx - 1 < 0 ? 0 : idx - 1, vCurr = v[idx]; v[pidx];
    ...
    var Tween = /** @class */ (function () {
        ...
        Tween.prototype.seek = function (time, keepPlaying) {
            var _a = this, _duration = _a._duration; _a._repeat; var _initTime = _a._initTime, _startTime = _a._startTime; _a._delayTime; var _reversed = _a._reversed;
        ...
        Tween.prototype.render = function () {
            ...
            var _a = this, _valuesStart = _a._valuesStart, _valuesEnd = _a._valuesEnd, object = _a.object, node = _a.node, InitialValues = _a.InitialValues; _a._easingFunction;
            SET_NESTED(object);
        ...
        Tween.prototype.stop = function () {
            var _a = this, _isPlaying = _a._isPlaying, _isFinite = _a._isFinite, object = _a.object, _startTime = _a._startTime; _a._delayTime; var _duration = _a._duration, _r = _a._r, _yoyo = _a._yoyo, _reversed = _a._reversed;
            if (!_isPlaying) {
                return this;
            }
